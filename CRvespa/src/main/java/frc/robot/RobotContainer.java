...
public class RobotContainer {
  ...
  // Subsystems
  public final Shooter shooter = Shooter.getInst();
  ...
  private void configureBindings() {
    JoystickButton rightButton = new JoystickButton(stick, SHOOTER);

    // Hold to shoot, release to stop
    rightButton.whileTrue(shooter.fuelInCommand());
    rightButton.onFalse(shooter.fuelStopCommand());
  }
